...
const productData = [
    {id: 1,product: "Продукт A",description: "Описание продукта A",price: "1000 руб."},{id: 2,product: "Продукт B",description: "Описание продукта B",price: "2000 руб."},{id: 3,product: "Услуга C",description: "Описание услуги C",price: "1500 руб."}
];
...
const News = ({ newsData, canEdit, onAddNews, onEdit, onDelete }) => (
    <article className="main-content">
        <h2>News</h2>
        {canEdit && <button onClick={() => onAddNews()}>Add News</button>}
        {newsData.map(news => (
            <NewsItem
                key={news.id}
                {...news}
        ...
        <div className="App">
            ...
            <div className="content-area">
                ...
                <Routes>
                    ...
                    <Route path="/news-form" element={<NewsForm onSave={handleSaveNews} initialData={currentNewsItem || {}} />} />
